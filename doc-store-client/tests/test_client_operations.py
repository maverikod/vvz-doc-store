...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "chapter_text_get",
            {"max_chars": 1200, "limit": 10000, "offset": 0, "chapter_id": "chapter-001", "include_context": True},
            TextReconstructionResult,
            {
                "entity": "chapter",
                "selector": {"chapter_id": "chapter-001"},
                "text": "chapter text",
                ...
                "chunk_count": 1,
                "paragraph_count": 1,
                "range_map": [{"chunk_id": "chunk-001"}],
                "truncated": False,
            },
        ),
        (
            "reconstruct_source_file",
            SourceFileReconstructRequest(document_id="doc-001", max_chars=1200),
            "source_file_reconstruct",
            {"document_id": "doc-001", "max_chars": 1200, "limit": 10000, "offset": 0},
            TextReconstructionResult,
            {
                "entity": "source_file",
                "selector": {"document_id": "doc-001"},
                "text": "source text",
                "preview": "source text",
                "body_sha256": "b" * 64,
                "char_count": 11,
