...
Inspect -> apply_patch -> inspect git diff -> re-read result -> run relevant checks. Preserve unrelated dirty changes.

## Exact native workflow

- Use CAS search, preview, and structural analysis for mutation preflight.
