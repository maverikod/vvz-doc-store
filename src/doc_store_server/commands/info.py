...
def build_info_document(registry: CommandHelpRegistry) -> InfoDocument:
    ...
    sections = {
        ...
        "vectorization_runtime": (
            ...
            "needs_revectorize flags, and never performs chunking. When an embed-client "
            "result item includes bm25_tokens, the vectorizer replaces that chunk's "
        ...
        "semantic_chunk_metadata": (
            ...
            "vectorizer workers process the new text. The public writer for safe chunk classifier metadata "
            "is semantic_chunk_metadata_update. It updates dictionary compatibility "
